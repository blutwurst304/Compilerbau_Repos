...
#line 421 "numbers.tab.c" /* yacc.c:339  */
...
#line 487 "numbers.tab.c" /* yacc.c:355  */
};
...
#line 504 "numbers.tab.c" /* yacc.c:358  */
...
{
       0,   386,   386,   387,   391,   393,   394,   397,   398,   402,
...
{
  "$end", "error", "$undefined", "BOTTOM", "TOP", "KOMMA", "AEQ", "IMP",
  "ODER", "UND", "NEG", "ALL", "EX", "AUF", "ZU", "PRAEDIKAT",
  "FUNKTIONSSYMBOL", "VARIABLE", "$accept", "termfolge", "term", "atom",
  "formel", YY_NULLPTR
};
#endif
...
{
       7,   -16,   -16,     7,     9,    15,     7,    23,   -16,    21,
     -16,     7,     7,    -2,   -15,   -16,     7,     7,     7,     7,
     -16,   -16,   -16,    24,   -16,    25,    33,    16,    26,    31,
     -16,   -15,   -16,   -15,    27,   -16,   -16
};
...
{
       0,    14,    13,     0,     0,     0,     0,     7,    19,     0,
       9,     0,     0,     0,     0,     1,     0,     0,     0,     0,
      11,    10,    12,     5,     4,     0,     3,    17,    18,    16,
      15,     0,     8,     0,     0,     2,     6
};
...
{
      10,    23,    24,    13,    16,    17,    18,    19,    20,    21,
       1,     2,    22,    27,    28,    29,    30,     3,     4,     5,
       6,    15,     7,    17,    18,    19,    11,    16,    17,    18,
      19,    34,    12,    35,    18,    19,    14,    31,    33,    32,
      19,    36
};

static const yytype_uint8 yycheck[] =
{
       3,    16,    17,     6,     6,     7,     8,     9,    11,    12,
       3,     4,    14,    16,    17,    18,    19,    10,    11,    12,
      13,     0,    15,     7,     8,     9,    17,     6,     7,     8,
       9,    31,    17,    33,     8,     9,    13,    13,     5,    14,
       9,    14
};
...
{
       0,     3,     4,    10,    11,    12,    13,    15,    21,    22,
      22,    17,    17,    22,    13,     0,     6,     7,     8,     9,
      22,    22,    14,    16,    17,    19,    20,    22,    22,    22,
      22,    13,    14,     5,    19,    19,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 386 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Termfolge\n"); (yyval.tf)=createTermfolge((yyvsp[-2].t), (yyvsp[0].tf));}
#line 1594 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 387 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Termfolge\n"); (yyval.tf)=createTermfolge((yyvsp[0].t), (termfolge*)0);}
#line 1600 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 391 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Term\n");(yyval.t)=createTerm("VARIABLE", (yyvsp[0].str), (termfolge*)0);}
#line 1606 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 393 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Term\n");(yyval.t)=createTerm("FUNKTION", (yyvsp[0].str), (termfolge*)0);}
#line 1612 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 394 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Term\n");(yyval.t)=createTerm("FUNKTION", (yyvsp[-3].str), (yyvsp[-1].tf));}
#line 1618 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 397 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Atom\n"); (yyval.a)=createAtom((yyvsp[0].str), (termfolge*)0);}
#line 1624 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 398 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Atom\n"); (yyval.a)=createAtom((yyvsp[-3].str), (yyvsp[-1].tf));}
#line 1630 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 402 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n"); (yyval.f)=createFormel("NEG", (char*)0, (yyvsp[0].f), (formel*)0, (atom*)0); root = (yyval.f);}
#line 1636 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 404 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n");(yyval.f)=createFormel("EX", (yyvsp[-1].str), (yyvsp[0].f), (formel*)0, (atom*)0); root = (yyval.f);}
#line 1642 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 406 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n");(yyval.f)=createFormel("ALL", (yyvsp[-1].str), (yyvsp[0].f), (formel*)0, (atom*)0); root = (yyval.f);}
#line 1648 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 408 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n");(yyval.f)=(yyvsp[-1].f); root = (yyval.f);}
#line 1654 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 410 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n");(yyval.f)=createFormel("TOP", (char*)0, (formel*)0, (formel*)0, (atom*)0); root = (yyval.f);}
#line 1660 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 412 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n");(yyval.f)=createFormel("BOTTOM", (char*)0, (formel*)0, (formel*)0, (atom*)0); root = (yyval.f);}
#line 1666 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 414 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n"); (yyval.f)=createFormel("UND", (char*)0, (yyvsp[-2].f), (yyvsp[0].f), (atom*)0); root = (yyval.f);}
#line 1672 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 416 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n");(yyval.f)=createFormel("ODER", (char*)0, (yyvsp[-2].f), (yyvsp[0].f), (atom*)0); root = (yyval.f);}
#line 1678 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 418 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n");(yyval.f)=createFormel("AEQ", (char*)0, (yyvsp[-2].f), (yyvsp[0].f), (atom*)0); root = (yyval.f);}
#line 1684 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 420 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n");(yyval.f)=createFormel("IMP", (char*)0, (yyvsp[-2].f), (yyvsp[0].f), (atom*)0); root = (yyval.f);}
#line 1690 "numbers.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 422 "numbers.y" /* yacc.c:1646  */
    {printf("Reduziere zu Formel\n");(yyval.f)=createFormel("ATOM", (char*)0, (formel*)0, (formel*)0, (yyvsp[0].a)); root = (yyval.f);}
#line 1696 "numbers.tab.c" /* yacc.c:1646  */
    break;


#line 1700 "numbers.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 423 "numbers.y" /* yacc.c:1906  */
